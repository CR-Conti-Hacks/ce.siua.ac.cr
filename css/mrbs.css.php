...
.error   {color: <?php echo $error ?>; font-weight: bold}                    /* for error messages */
.warning {color: <?php echo $warning  ?>}                        /* for warning messages */
...
tr.even_row td.new {background-color: <?php echo $row_even_color ?>; border: 1px solid #D4D4D4; }
tr.odd_row td.new {background-color: <?php echo $row_odd_color ?>; border: 1px solid #D4D4D4;}
...
fieldset.admin {width: 100%; padding: 0 1.0em 1.0em 1.0em;
    border: 1px solid <?php echo $admin_field_border_color ?>}
...
.form_admin fieldset {float: left; width: auto; border: 1px solid <?php echo $admin_field_border_color ?>; padding: 1em}
...
#dwm_header h3 {font-weight: normal; 
...
.dwm_main th {font-size: small; font-weight: normal; vertical-align: top; padding: 0;
    ...
    border-left: <?php echo $main_table_cell_border_width ?>px solid <?php echo $main_table_header_border_color ?>; padding: 10px; vertical-align: middle;}
...
.dwm_main th a:hover   {color: <?php echo $anchor_hover_color_header ?>;   text-decoration:none; font-weight: normal}
...
.dwm_main#month_main td {border:  <?php echo $main_table_cell_border_width ?>px solid <?php echo $main_table_body_v_border_color ?>}
...
#day_main, #week_main, #month_main{
    border: 1px solid #D1D9DE; padding: 2px;
}
...
.dwm_main td.row_labels     {background-color: <?php echo $main_table_labels_back_color ?>; white-space: nowrap; padding: 2px;}    /* used for the row labels column */
...
.dwm_main tbody tr:hover a:link,    td.row_labels_hover a:link    {color: <?php echo $Link_de_label_header_calendar ?>; text-decoration: none;}
...
#banner a:hover   {color: <?php echo $anchor_hover_color_banner ?>;   text-decoration:none; font-weight: normal}
#banner input.date {width: 6.5em; text-align: center}

table#colour_key {clear: both; float: left; border-spacing: 0; border-collapse: collapse;  min-width: 470px;   margin: 0.7em;}
...
.calendar th {min-width: 2.0em; text-align: center; font-weight: normal; background-color: <?php echo $banner_calendario ?>; color: <?php echo $header_font_color ?>}
...
#entry{ width: 700px; }
#entry, #entry tr,#entry td { border: 1px solid #B7B7B7; border-collapse: collapse;}
.view_entry #entry td:first-child {text-align: left; font-weight: bold; padding: 0.3em; background-color: #014FBE; color: #FFFFFF; width: 280px; }
...
input:focus, textarea:focus, select:focus, checkbox:focus, radio:focus {
    border: 2px solid #2FA4CE;
    background: #BFE4F2;
}

/************************************************/
/***** quitar borde rojo de firefox required ****/
/************************************************/
...
/****************************************************/
/***** fin quitar borde rojo de firefox required ****/
/****************************************************/
...
.tabla_miembros td, .tabla_miembros tr {border: 1px solid #D7DCE0; padding-top: 5px;}
/*********************************************************************/
/******************* Fin de CSS UGIT   *******************************/
/*********************************************************************/